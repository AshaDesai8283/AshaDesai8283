...
$sql="insert into tblappointment(Name,MobileNumber,Email,AppointmentDate,AppointmentTime,Specialization,Message)values(:name,:mobnum,:email,:appdate,:aaptime,:specialization,:message)";
...
$query->bindParam(':message',$message,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) 
   {
        $sql=$dbh->prepare("SELECT * FROM tbldoctor WHERE Specialization=:specialization");
        $sql->execute(array(':specialization' => $specialization));


        while($row =$sql->fetch())
        { ?>
           <script> alert ( <?php echo $row["FullName"]; echo "<br/>"; echo $row['MobileNumber']; echo "<br/>"; echo $row['Specialization']; ?> );</script>
           <?php
        }
...
<html lang="en">
    <head>
        <title>Wellable || Home Page</title>
                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="images/slider/doctor-man-consulting-patient-while-filling-up-application-form-desk-hospital.jpg" class="img-fluid" alt="">
                                    </div>
...
{               ?>
                        ...
                        <div class="col-lg-4 col-md-5 col-12 mx-auto">
                            <div class="featured-circle bg-white shadow-lg d-flex justify-content-center align-items-center">
                                <p class="featured-text"> one step closer to <br>excellent healthcare </p>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6 ps-0">
                            <img src="images/gallery/indian-doctor-receives-patient-tells-him-about-results-tests-medicine-health.jpg" class="img-fluid galleryImage" alt="get a vaccine" title="get a vaccine for yourself">
                        </div>

                        <div class="col-lg-6 col-6 pe-0">
                            <img src="images/gallery/doctor-talking-with-his-patient-clinic.jpg" class="img-fluid galleryImage" alt="wear a mask" title="wear a mask to protect yourself">
                        </div>
